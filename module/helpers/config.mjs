...
SKSK.skills = {
  ...
  immunity: {
    fireImmunity: { label: 'SKSK.Skill.Immunity.FireImmunity', maxLevel: 10 },
    waterImmunity: { label: 'SKSK.Skill.Immunity.WaterImmunity', maxLevel: 10 },
    earthImmunity: { label: 'SKSK.Skill.Immunity.EarthImmunity', maxLevel: 10 },
    airImmunity: { label: 'SKSK.Skill.Immunity.AirImmunity', maxLevel: 10 },
    lightImmunity: { label: 'SKSK.Skill.Immunity.LightImmunity', maxLevel: 10 },
    darkImmunity: { label: 'SKSK.Skill.Immunity.DarkImmunity', maxLevel: 10 },
    lifeImmunity: { label: 'SKSK.Skill.Immunity.LifeImmunity', maxLevel: 10 },
    deathImmunity: { label: 'SKSK.Skill.Immunity.DeathImmunity', maxLevel: 10 },
    mentalImmunity: { label: 'SKSK.Skill.Immunity.MentalImmunity', maxLevel: 10 },
    natureImmunity: { label: 'SKSK.Skill.Immunity.NatureImmunity', maxLevel: 10 },
    coldImmunity: { label: 'SKSK.Skill.Immunity.ColdImmunity', maxLevel: 10 },
    heatImmunity: { label: 'SKSK.Skill.Immunity.HeatImmunity', maxLevel: 10 },
    bluntImmunity: { label: 'SKSK.Skill.Immunity.BluntImmunity', maxLevel: 10 },
    sharpImmunity: { label: 'SKSK.Skill.Immunity.SharpImmunity', maxLevel: 10 },
    piercingImmunity: { label: 'SKSK.Skill.Immunity.PiercingImmunity', maxLevel: 10 },
    poisonImmunity: { label: 'SKSK.Skill.Immunity.PoisonImmunity', maxLevel: 10 },
    acidImmunity: { label: 'SKSK.Skill.Immunity.AcidImmunity', maxLevel: 10 },
    electricityImmunity: { label: 'SKSK.Skill.Immunity.ElectricityImmunity', maxLevel: 10 },
    iceImmunity: { label: 'SKSK.Skill.Immunity.IceImmunity', maxLevel: 10 },
    diseaseImmunity: { label: 'SKSK.Skill.Immunity.DiseaseImmunity', maxLevel: 10 },
  },
  absorb: {
    fireAbsorption: { label: 'SKSK.Skill.Absorb.FireAbsorption', maxLevel: 10 },
    waterAbsorption: { label: 'SKSK.Skill.Absorb.WaterAbsorption', maxLevel: 10 },
    earthAbsorption: { label: 'SKSK.Skill.Absorb.EarthAbsorption', maxLevel: 10 },
    airAbsorption: { label: 'SKSK.Skill.Absorb.AirAbsorption', maxLevel: 10 },
    lightAbsorption: { label: 'SKSK.Skill.Absorb.LightAbsorption', maxLevel: 10 },
    darkAbsorption: { label: 'SKSK.Skill.Absorb.DarkAbsorption', maxLevel: 10 },
    lifeAbsorption: { label: 'SKSK.Skill.Absorb.LifeAbsorption', maxLevel: 10 },
    deathAbsorption: { label: 'SKSK.Skill.Absorb.DeathAbsorption', maxLevel: 10 },
    mentalAbsorption: { label: 'SKSK.Skill.Absorb.MentalAbsorption', maxLevel: 10 },
    natureAbsorption: { label: 'SKSK.Skill.Absorb.NatureAbsorption', maxLevel: 10 },
    coldAbsorption: { label: 'SKSK.Skill.Absorb.ColdAbsorption', maxLevel: 10 },
    heatAbsorption: { label: 'SKSK.Skill.Absorb.HeatAbsorption', maxLevel: 10 },
    bluntAbsorption: { label: 'SKSK.Skill.Absorb.BluntAbsorption', maxLevel: 10 },
    sharpAbsorption: { label: 'SKSK.Skill.Absorb.SharpAbsorption', maxLevel: 10 },
    piercingAbsorption: { label: 'SKSK.Skill.Absorb.PiercingAbsorption', maxLevel: 10 },
    poisonAbsorption: { label: 'SKSK.Skill.Absorb.PoisonAbsorption', maxLevel: 10 },
    acidAbsorption: { label: 'SKSK.Skill.Absorb.AcidAbsorption', maxLevel: 10 },
    electricityAbsorption: { label: 'SKSK.Skill.Absorb.ElectricityAbsorption', maxLevel: 10 },
    iceAbsorption: { label: 'SKSK.Skill.Absorb.IceAbsorption', maxLevel: 10 },
  },
  special: {
