...
SKSK.skills = {
  ...
  misc: {
    ...
    survival: { label: 'SKSK.Skill.Misc.Survival', maxLevel: 10, attributes: ['con', 'per', 'dex'], attributeMode: 'choice', attributeBonusThresholds: [{ level: 5, mode: 'choice', attributes: ['con', 'per', 'dex'] }, { level: 10, mode: 'choice', attributes: ['con', 'per', 'dex'] }] },
